...
public class customerActions extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        in=(TextView) findViewById(R.id.inVehicleStatus) ;
    ...
    protected void onStart() {
        ...
        DatabaseReference getb3 = FirebaseDatabase.getInstance().getReference();
    ...
    private void invehicleStatus(DataSnapshot dataSnapshot) {
        getInvehicle present2 = new getInvehicle();

        present2.setInVehicle(dataSnapshot.child("users").child("vehiclePConnection").child(vehiid3).child(userid).getValue(presentStatus.class).getInVehicle());
