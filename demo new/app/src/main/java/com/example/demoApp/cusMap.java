...
public class cusMap extends FragmentActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener {
    ...
    private FloatingActionButton location,logout;
    ...
    public void onLocationChanged(Location location) {
        if(check) {
            ...
            if(checkLoMetho){
                ...
                dis.setText("Vehicle Found:" +String.valueOf(distancecal)+"m");
                vibrator = (Vibrator) getSystemService(VIBRATOR_SERVICE);
                if(distancecal <= 200.0f)
                {
                       vibrator.vibrate(500);
                    Toast.makeText(getApplicationContext(), "Your child is reaching to your location soon", Toast.LENGTH_SHORT).show();
    ...
    protected void onStart() {
        ...
        String userid6 = FirebaseAuth.getInstance().getCurrentUser().getUid();
        DatabaseReference getb1 = FirebaseDatabase.getInstance().getReference("users").child("Customers").child(userid6);
        getb1.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
        ...
        //DatabaseReference getb3 = FirebaseDatabase.getInstance().getReference("users").child("vehiclePConnection").child(vehiid3).child(userid2);
        //getb3.addValueEventListener(new ValueEventListener() {
           // @Override
           // public void onDataChange(DataSnapshot dataSnapshot) {

                //invehicleStatus(dataSnapshot);
    ...
    private void showdata2(DataSnapshot dataSnapshot) {
        ...
        getvehicleID vi = new getvehicleID();
        vi.setVehicleID(dataSnapshot.getValue(getvehicleID.class).getVehicleID());
       String vehiid34 = vi.getVehicleID();


        DatabaseReference getb3 = FirebaseDatabase.getInstance().getReference("users").child("vehiclePConnection").child(vehiid34).child(userid2);

        getb3.addListenerForSingleValueEvent(new ValueEventListener() {
             @Override
             public void onDataChange(DataSnapshot dataSnapshot) {

                 getPresentStatusForIN present2 = new getPresentStatusForIN();

                 present2.setInVehicle(dataSnapshot.getValue(getPresentStatusForIN.class).getInVehicle());
                 String ps2 = present2.getInVehicle();
                 ...
                 vibrator.vibrate(500);
                 AlertDialog.Builder builder = new AlertDialog.Builder(cusMap.this);
                 builder.setTitle("passenger Status ");
                 builder.setMessage("Your child has been inside the school bus");
                 ...
                 alert.show();
                  ...
                  else if(ps2.equals("NO")){

                 vibrator.vibrate(1000);
                 AlertDialog.Builder builder = new AlertDialog.Builder(cusMap.this);
                  builder.setTitle("passenger Status ");
                  builder.setMessage("Your child has been outside the school bus");
                  builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                  @Override
                 public void onClick(DialogInterface dialog, int which) {
    ...
    private void invehicleStatus(DataSnapshot dataSnapshot) {




        //getvehicleidForstatus vi = new getvehicleidForstatus();
       // vi.setVehicleID(dataSnapshot.child("users").child("Customers").child(userid2).getValue(getvehicleID.class).getVehicleID());
      // String vehiid4 = vi.getVehicleID();


        getPresentStatusForIN present2 = new getPresentStatusForIN();

       // present2.setInVehicle(dataSnapshot.child("inVehicle").getValue(getPresentStatusForIN.class).getInVehicle());
        //String ps2 = present2.getInVehicle();
        //vibrator = (Vibrator) getSystemService(VIBRATOR_SERVICE);
